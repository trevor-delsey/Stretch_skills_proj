...
full_model_transform <- cox.zph(Surv(relapse_free_status_months, relapse) ~ pam50_claudin_low_subtype +
                     age_at_diagnosis +
                     tt(age_at_diagnosis) +
                     cohort +
                     inferred_menopausal_state +
...
no_tumor_stage <- coxph(surv ~ pam50_claudin_low_subtype +
                     age_at_diagnosis +
                     inferred_menopausal_state +
                     lymph_nodes_examined_positive +
                     npi_cat +
...
no_tumor_size <- coxph(surv ~ pam50_claudin_low_subtype +
                     age_at_diagnosis +
                     inferred_menopausal_state +
                     lymph_nodes_examined_positive +
                     npi_cat +
...
no_chemo <- coxph(surv ~ pam50_claudin_low_subtype +
                     age_at_diagnosis +
                     inferred_menopausal_state +
                     lymph_nodes_examined_positive +
                     npi_cat +
...
no_npi <- coxph(surv ~ pam50_claudin_low_subtype +
                     age_at_diagnosis +
                     inferred_menopausal_state +
                     lymph_nodes_examined_positive +
                     tumor_size +
...
no_lymph <- coxph(surv ~ pam50_claudin_low_subtype +
                     age_at_diagnosis +
                     inferred_menopausal_state +
                     chemotherapy +
                     tumor_size +
...
no_menopause <- coxph(surv ~ pam50_claudin_low_subtype +
                     age_at_diagnosis +
                     lymph_nodes_examined_positive +
                     tumor_size +
                     type_of_breast_surgery +
...
no_age <- coxph(surv ~ pam50_claudin_low_subtype +
                     inferred_menopausal_state +
                     lymph_nodes_examined_positive +
                     tumor_size +
                     type_of_breast_surgery +
...
final_model <- coxph(surv ~ pam50_claudin_low_subtype +
                     age_at_diagnosis +
                     inferred_menopausal_state +
                     lymph_nodes_examined_positive +
                     npi_cat +
